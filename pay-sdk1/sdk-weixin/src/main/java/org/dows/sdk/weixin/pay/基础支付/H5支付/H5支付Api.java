...
public interface H5支付Api{
    ...
    /**
     * description: 发起商家转账API,最新更新时间：2022.04.24,商户可以通过该接口同时向多个用户微信零钱进行转账操作。
    ...
    /**
     * description: 微信批次单号查询批次单API,最新更新时间：2022.4.6,商户可以通过该接口查询转账批次单以及指定状态的转账明细单。
    ...
    /**
     * description: 微信明细单号查询明细单API,最新更新时间：2022.08.09,商户可以通过该接口查询单笔转账明细单。
    ...
    /**
     * description: 商家批次单号查询批次单API,最新更新时间：2022.4.6,商户可以通过该接口查询转账批次单以及指定状态的转账明细单。
    ...
    /**
     * description: 转账明细电子回单受理API,最新更新时间：2021.10.26,受理转账明细电子回单接口，商户通过该接口可以申请受理转账明细单电子回单服务。
    ...
    /**
     * description: 查询转账明细电子回单受理结果API,最新更新时间：2021.10.26,查询转账明细电子回单受理结果接口，商户通过该接口可以查询电子回单受理进度信息，包括电子回单据信息，电子回单文件的hash值，电子回单文件的下载地址等。
    ...
    /**
     * description: 下载电子回单API,最新更新时间：2021.10.26,下载电子回单API为通用接口，商家转账等业务电子回单均可通过该接口进行下载。
    ...
    /**
     * description: 商家明细单号查询明细单API,最新更新时间：2022.08.09,商户可以通过该接口查询单笔转账明细单。
    ...
    /**
     * description: 转账电子回单申请受理API,最新更新时间：2021.10.26,转账电子回单申请受理接口，商户通过该接口可以申请受理电子回单服务。
    ...
    /**
     * description: 查询转账电子回单API,最新更新时间：2021.10.26,查询转账电子回单接口，商户通过该接口可以查询电子回单受理进度信息，包括电子回单据信息，电子回单文件的hash值，电子回单文件的下载地址等
