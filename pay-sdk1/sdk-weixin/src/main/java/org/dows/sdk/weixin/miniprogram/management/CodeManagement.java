 ...
 * 
 */
public interface codeManagement{
     ...
     * https://api.weixin.qq.com/wxa/get_page?access_token=ACCESS_TOKEN
     * 
     ...
     * https://api.weixin.qq.com/wxa/get_qrcode?access_token=ACCESS_TOKENHTTP/1.1 200 OK Connection: close Content-Type: image/jpeg Content-disposition: attachment; filename="QRCode.jpg" Date: Sun, 06 Jan 2013 10:20:18 GMT Cache-Control: no-cache, must-revalidate Content-Length: 339721
     * 
     ...
     * https://api.weixin.qq.com/wxa/get_auditstatus?access_token=ACCESS_TOKEN
     * 
     ...
     * https://api.weixin.qq.com/wxa/undocodeaudit?access_token=ACCESS_TOKEN
     * 
     ...
     * https://api.weixin.qq.com/wxa/revertcoderelease?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 
     * https://api.weixin.qq.com/wxa/grayrelease?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 该接口用于查询当前分阶段发布详情
     * https://api.weixin.qq.com/wxa/getgrayreleaseplan?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 
     * https://api.weixin.qq.com/wxa/change_visitstatus?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 
     * https://api.weixin.qq.com/wxa/revertgrayrelease?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 
     * https://api.weixin.qq.com/wxa/getvisitstatus?access_token=ACCESS_TOKEN
     * 
     ...
     * https://api.weixin.qq.com/cgi-bin/wxopen/getweappsupportversion?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 
     * https://api.weixin.qq.com/cgi-bin/wxopen/setweappsupportversion?access_token=ACCESS_TOKEN
     * 
     ...
     * https://api.weixin.qq.com/wxa/queryquota?access_token=ACCESS_TOKEN
     * 
     ...
     * https://api.weixin.qq.com/wxa/speedupaudit?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 
     * https://api.weixin.qq.com/wxa/getversioninfo?access_token=ACCESS_TOKEN
     * 
    ...
    /**
     * 
     * https://api.weixin.qq.com/wxa/security/get_code_privacy_info?access_token=ACCESS_TOKEN
     * 
