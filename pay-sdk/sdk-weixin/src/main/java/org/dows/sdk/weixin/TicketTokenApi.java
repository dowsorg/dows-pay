...
import org.dows.sdk.weixin.request.*;
import org.dows.sdk.weixin.response.*;
...
public interface TicketTokenApi {
    ...
    /**
     * 该 API 用于启动ticket推送服务。使用过程中如遇到问题，可在发帖交流。
    ...
    /**
     * 该接口用于获取预授权码（pre_auth_code）是第三方平台方实现授权托管的必备信息，每个预授权码有效期为 1800秒。使用过程中如遇到问题，可在发帖交流。
    ...
    /**
     * 该接口用于获取授权帐号的authorizer_access_token。authorizer_access_token 有效期为 2 小时，authorizer_access_token 失效时，可以使用 authorizer_refresh_token 获取新的 authorizer_access_token。使用过程中如遇到问题，可在发帖交流。
    ...
    /**
     * https://api.weixin.qq.com/cgi-bin/component/api_query_auth?access_token=ACCESS_TOKEN
     *
