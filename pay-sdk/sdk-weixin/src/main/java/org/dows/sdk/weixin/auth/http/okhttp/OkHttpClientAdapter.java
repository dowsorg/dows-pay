package org.dows.sdk.weixin.auth.http.okhttp;
...
import org.dows.sdk.weixin.auth.exception.HttpException;
import org.dows.sdk.weixin.auth.exception.MalformedMessageException;
import org.dows.sdk.weixin.auth.exception.ServiceException;
...
public final class OkHttpClientAdapter extends AbstractHttpClient {
    ...
    private RequestBody buildOkHttpRequestBody(
            org.dows.sdk.weixin.auth.http.RequestBody wechatPayRequestBody) {
