...
public class InAlipayDIYQRCodeEnterExecutor implements ActionExecutor {
    ...
    public String execute() throws PayException {
        ...
        try {
            JSONObject actionParam = new JSONObject(bizContent.getStr("ActionParam"));
            JSONObject scene = new JSONObject(actionParam.get("scene"));
            String sceneId = scene.getStr("sceneId");
            ...
            throw new PayException("转换json错误，检查数据格式");
        }
