package org.dows.pay.weixin.mp.ticket;
...
import org.dows.pay.weixin.mp.ticket.bean.Ticket;
...
public class Tickets {
    ...
    public Ticket temporary(int expires, int sceneId) {
        ...
        log.debug("create temporary ticket : {}", String.format(json, expires, sceneId));
    ...
    public Ticket permanent(int sceneId) {
        ...
        log.debug("create permanent ticket : {}", String.format(json, sceneId));
    ...
    public Ticket permanent(String sceneStr) {
        ...
        log.debug("create permanent ticket : {}", String.format(json, sceneStr));
