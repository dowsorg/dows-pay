package org.dows.pay.weixin.mp.card;
...
import org.dows.pay.weixin.mp.card.bean.Cash;
import org.dows.pay.weixin.mp.card.bean.Gift;
import org.dows.pay.weixin.mp.card.bean.Groupon;
...
public class Cards {
    ...
    public void setWhiteList(List<String> openIds, List<String> userNames) {
        ...
        String json = JsonMapper.defaultMapper().toJson(request);
        log.debug("set test white list: {}", json);
    ...
    String getContentByCardId(String cardId) {
        ...
        String json = JsonMapper.defaultMapper().toJson(request);
        log.debug("get mpnews content by card id: {}", json);
        String response = wxClient.post(url, json);
        Map<String, Object> result = JsonMapper.defaultMapper().json2Map(response);
