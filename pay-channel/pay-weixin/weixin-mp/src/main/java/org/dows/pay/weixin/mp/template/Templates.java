...
public class Templates {
    ...
    public void setIndustries(String primary, String secondary) {
        ...
        log.debug("template message, set industry: {}", json);
    ...
    public Industry getIndustries() {
        ...
        log.debug("template message, get industry.");
    ...
    public String fetch(String code) {
        ...
        log.debug("template message, get template id: {}", json);
    ...
    public List<Template> list() {
        ...
        log.debug("template message, list templates.");
        String response = wxClient.get(url);
    ...
    public void delete(String templateId) {
        ...
        log.debug("template message, delete template: {}", json);
        wxClient.post(url, json);
    }
    ...
    public long send(String toUser, String templateId, String url, MiniProgram miniProgram, Map<String, Data> messages) {
        ...
        log.debug("template message, send message: {}", json);
